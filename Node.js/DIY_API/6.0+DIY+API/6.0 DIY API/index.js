...
app.put("/jokes/:id", (req, res)=>{
  ...
  const searchIndex = jokes.findIndex(joke=>joke.id === index);
...
app.patch("/jokes/:id", (req, res)=>{
  ...
  if(req.body.text){
    replacementJoke.jokeText = req.body.text;
  }else if(req.body.type){
    replacementJoke.jokeType = req.body.type;
  }
  // const existingJoke = jokes.find(joke=>joke.id === id);
  // const replacementJoke = {
  //   id : id,
  //   jokeText : req.body.text || existingJoke.jokeText,
  //   jokeType : req.bopy.type || existingJoke.jokeType,
  // }
